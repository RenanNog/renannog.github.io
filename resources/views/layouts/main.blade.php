...
<body>
    <header style="display:flex;">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse" id="navbar">
                <a href="/" class="navbar-brand"></a>
                    <img src="/img/logo.png" alt=" blog teste" style="width: 50px;">
                </a>
                <ul class="navbar-nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="/postagens/criar" class="nav-link">Criar postagens</a>
                    </li>
                    <li class="nav-item">
                        <a href="/userpanel" class="nav-link">Painel do usuario</a>
                    </li>
                </ul>   
            </div>
        </nav>
        <div class="User-info">
            ...
            @else
                <button><a href="/login">Entre</a></button>
